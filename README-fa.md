...
- [x] **سیستم پیام‌رسانی**
  ...
  - [x] پشتیبانی چندکاناله
  - [x] ماندگاری پیام با IndexedDB
  - [x] مسیریابی پیام با TTL (مدت زمان زندگی)

- [x] **امنیت**
  - [x] رمزنگاری سرتاسری با TweetNaCl
  - [x] استخراج کلید با Scrypt
  - [x] امضا و تأیید پیام
  - [x] محافظت کانال با رمز عبور

- [x] **رابط کاربری**
  - [x] طراحی مدرن ریسپانسیو
  - [x] کتابخانه کامپوننت shadcn/ui
  - [x] پشتیبانی تم تاریک/روشن
  - [x] رابط بهینه شده برای موبایل
  - [x] نشانگرهای وضعیت اتصال

- [x] **تجربه توسعه‌دهنده**
  - [x] حالت سخت TypeScript
  - [x] پیکربندی ESLint + Prettier
  - [x] سیستم ساخت Vite
  - [x] جایگزینی ماژول داغ

### 🔄 در حال انجام

- [ ] **امنیت پیشرفته**
  - [ ] پیاده‌سازی Perfect Forward Secrecy
  - [ ] مکانیزم‌های چرخش کلید
  - [ ] احراز هویت امن همتا

- [ ] **بهینه‌سازی عملکرد**
  - [ ] فشرده‌سازی پیام
  - [ ] الگوریتم‌های مسیریابی کارآمد
  - [ ] بهینه‌سازی باتری
